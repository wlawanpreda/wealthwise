...
export const Input = React.forwardRef<HTMLInputElement, InputProps>(
  ({ className, label, error, leftIcon, rightIcon, containerClassName, variant = 'default', ...props }, ref) => {
    return (
        ...
        <div className="relative group">
          ...
          <input
            ...
            className={cn(
              ...
              variant === 'default' && 'bg-brand-surface border border-brand-border focus:ring-2 focus:ring-blue-600/10 focus:border-blue-600/30',
